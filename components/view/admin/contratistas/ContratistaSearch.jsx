...
import { FaSearch, FaFilter, FaTimes, FaCheckCircle, FaBan } from 'react-icons/fa';

export default function ContratistaSearch({ onSearch, loading }) {
  ...
  const estados = [
    ...
    { value: 'true', label: 'Activos', icon: <FaCheckCircle className="text-green-600" /> },
    { value: 'false', label: 'Inactivos', icon: <FaBan className="text-red-600" /> }
  ];
