...
export const connectDB = async () => {
  try {
    // Validar la URI en tiempo de ejecución (no al importar el módulo),
    // para que el build de Next no falle al recolectar rutas sin env.
    if (!MONGODB_URI) {
